      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-[#4169E1]">
            ...
            <p className="text-gray-700">Know your compliance health out of 100 and improve it with government-ready suggestions.</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-[#43CD80]">
            ...
            <p className="text-gray-700">Ask AI how to improve your MSME’s legal standing and get instant step-by-step guidance.</p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-yellow-400">
            ...
            <p className="text-gray-700">Download your auto-generated compliance report (PDF) for banks, tenders, and verification.</p>
          </div>
        </div>
